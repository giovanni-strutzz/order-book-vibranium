...
* [Spring Data Reactive Redis](https://docs.spring.io/spring-boot/4.0.4/reference/data/nosql.html#data.nosql.redis)
* [MongoDB](https://docs.spring.io/spring-boot/4.0.4/reference/data/nosql.html#data.nosql.mongodb)
